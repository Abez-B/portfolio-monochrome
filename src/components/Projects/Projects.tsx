...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      thumbnail: 'https://via.placeholder.com/300x200?text=Deepfake+AI', // Placeholder thumbnail
      liveDemo: '#', // Placeholder
      githubRepo: '#', // Placeholder
      category: 'AI/ML',
    },
    {
      ...
      thumbnail: 'https://via.placeholder.com/300x200?text=Sentiment+Analysis', // Placeholder thumbnail
      liveDemo: '#', // Placeholder
      githubRepo: '#', // Placeholder
      category: 'AI/ML',
    },
    {
      ...
      thumbnail: 'https://via.placeholder.com/300x200?text=AI/ML+Implementations', // Placeholder thumbnail
      liveDemo: '#', // Placeholder
      githubRepo: '#', // Placeholder
      category: 'AI/ML',
    },
    {
      ...
      thumbnail: 'https://via.placeholder.com/300x200?text=DBMS+Projects', // Placeholder thumbnail
      liveDemo: '#', // Placeholder
      githubRepo: '#', // Placeholder
      category: 'Database',
    },
    {
      ...
      thumbnail: 'https://via.placeholder.com/300x200?text=OS+Systems', // Placeholder thumbnail
      liveDemo: '#', // Placeholder
      githubRepo: '#', // Placeholder
      category: 'Systems',
    },
    ...
    <section id="projects" className="bg-black text-white dark:bg-white dark:text-black py-16 px-4" data-aos="fade-up">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          ...
          <button onClick={() => setFilter('Web Apps')} className={`text-white dark:text-gray-700 hover:text-gray-400 dark:hover:text-gray-900 transition-colors duration-300 ${filter === 'Web Apps' ? 'border-b-2 border-gray-400 dark:border-gray-900' : ''}`}>Web Apps</button>
